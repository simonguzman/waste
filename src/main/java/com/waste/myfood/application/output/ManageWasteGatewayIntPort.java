...
public interface ManageWasteGatewayIntPort {
     ...
     * @return {@code Waste} el objeto Waste correspondiente o {@code null} si no se
     *         encuentra.
     */
     ...
     * @return {@code List<Waste>} Lista de objetos Waste que representan los
    ...
    List<Waste> saveAll(List<Waste> wastes);
     ...
     * @return {@code double} La cantidad total de desperdicio registrada para el
